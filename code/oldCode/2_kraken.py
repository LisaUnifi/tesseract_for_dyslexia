...
path = 'C:/Users/lisac/Desktop/MarinaiProgetto/image/'
...
for f in font:
    ...
    os.mkdir(pdir)
    image = convert_from_path('C:/Users/lisac/Desktop/MarinaiProgetto/font/font_'+ font[f] +'.pdf') 
    count = 1
    for i in image:
...
path2 = 'C:/Users/lisac/Desktop/MarinaiProgetto/data/'
for f in font:
    directory = font[f]
